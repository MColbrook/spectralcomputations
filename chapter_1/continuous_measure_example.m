...
exportgraphics(gcf,sprintf('CHAP1_MT_meas_N%d.pdf',N),'ContentType','vector','BackgroundColor','none','Colorspace','gray')
...
ff.Position=[525.6667  343.0000  560.0000  284.6667];
exportgraphics(gcf,sprintf('CHAP1_MT_cdf_N%d.pdf',N),'ContentType','vector','BackgroundColor','none','Colorspace','gray')
...
exportgraphics(gcf,'CHAP1_MT_cdf.pdf','ContentType','vector','BackgroundColor','none','Colorspace','gray')
