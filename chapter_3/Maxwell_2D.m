...
% ylim([0.0001,10])
% % exportgraphics(gcf,'CHAP3_maxwell_rate1.pdf','ContentType','vector','BackgroundColor','none','Colorspace','gray')
...
% exportgraphics(gcf,'CHAP3_maxwell_rate2.pdf','ContentType','vector','BackgroundColor','none','Colorspace','gray')
