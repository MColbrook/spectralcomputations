...
%%%%%%%%%%%%%%%% CODE FOR UNDAMPED DUFFING EXAMPLE %%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
title(sprintf('Eigenvalues ($N=%d$, undamped)',N),'interpreter','latex','fontsize',18)
xlabel('$\mathrm{Re}(\lambda)$','interpreter','latex','fontsize',18)
ylabel('$\mathrm{Im}(\lambda)$','interpreter','latex','fontsize',18)
ax=gca; ax.FontSize=18;

% plot some of the eigenfunctions corresponding to lambda = 1
...
loglog([0.01,1],[0.01,1],':k','linewidth',1)
hold on
loglog(sqrt(abs(abs(LAM).^2-1)),R,'k.','markersize',20)
xlabel('$\sqrt{1-|\lambda|^2}$','interpreter','latex','fontsize',18)
title('EDMD Eigenpair Residuals (undamped)','interpreter','latex','fontsize',18)
ax=gca; ax.FontSize=18;
...
title(sprintf('$\\mathrm{Sp}_\\epsilon(\\mathcal{K})$ ($N=%d$, undamped)',N),'interpreter','latex','fontsize',18)
ax=gca; ax.FontSize=18;
